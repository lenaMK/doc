...
- projet intitulé [*Bayt wa Balad*](https://mpp-dc.org/baytwabalad/)
...
Ce processus de recherche nous ainsi donne accès à des fragments de son histoire. 
...
-  [CatalogIt](https://catalogit.app/), un système de gestion de collection également employé par le Musée Palestinien (Birzeit, Palestine)
...
- [slide]
- documentation détaillée de la biographie de chaque objet 
- [slide]
- méthode « sur mesure », faisant usage de la flexibilité de CatalogIt, pour entrer ces données. 
...
→ pas un point sur la carte mais une zone mettant en valeur les villages concernés (exemple issu du processus de recherche)

[slide]

Retravailler le modèle de données pour trouver des façons plus riches de décrire ce que nous savons sur les objets. 
...
- La bibliographie que j’ai créée pour le projet,[ accessible sur Zotero](https://www.zotero.org/groups/6331652/bayt-wa-balad/library), recense les recherches et les pratiques existantes autour de la cartographie en Palestine.

Pour travailler sur un fond de carte qui reflète une perspective palestinienne du territoire, nous avons contacté les créateurs de [Palestine Open Maps](https://palopenmaps.org/en), Majd Al-Shihabi et Ahmad Barclay, qui travaillent depuis plusieurs années à vectoriser des cartes qui pré-datent la création de l’État d’Israël. 
...
Deux enjeux importants, la structuration des données et la cartographie, d'un projet en cours. Prototype semi-public en mai, la mise en ligne est prévue pour 2027.
...
- type index: un petit objet par objet dans la collection → comme les mini-cartels = collection documentée actuelle (148 objets)
- exprimer les différences et similarités entre les objets par des variables visuelles

- Exemples d'une image générée par un algoritme
- mosaïque de la collection, associe une forme à chaque objet selon sa catégorisation
- Variables à explorer
  - catégorie artistique
  - époque: pré-mandat britannique, mandat britannique, Nakba
