...
*Salut, moi c’est Lena MK, j’ai écrit une description sensorielle de mon projet intitulé Célébration de données molles et j’en fais ici la lecture. La description est divisée en plusieurs parties, comme des petits épisodes d’un balado. À partir d’une description de l’installation qui présentait le projet de recherche-création, je vais ensuite détailler chacune des étapes de travail, de l’espace numérique à la transposition vers l’espace physique, la fabrication, et les rencontres qui s’en sont suivies. À l’instar d’une médiation guidée, ou d’une livre audio, je vous propose de fermer les yeux et d’écouter le son de ma voix vous guider à travers l’expérience de la Célébration de données molles.*
...
## Partie 3 - L’espace physique (10 min)
...
D’une part, j’ai donc dû réduire l’échelle de mon projet: au lieu d’aborder la collection complète, j’ai réduit à une seule des douze catégories artistiques présentes dans la collection. Plutôt que de travailler sur les peintures ou les sculptures, je me suis focalisée sur la catégorie qu’on appelle les « techniques mixtes ». En fait, on la considère

techniques mixtes



## Partie 4 - La fabrication (8-10 min)

commande



### Structure et organisation matérielle

matériel secondaire



structure . dimensions, cercle

### La fabrication des guirlandes, entre l’interface et le geste
