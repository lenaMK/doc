...
Inscribing the elements of *[…] and counting* into an academic narrative is an opportunity to expose the back-and-forth dynamic between research and creation, where theory serves as inspiration and practice provides fertile ground to further theory. This article will follow a slow backwards movement. It begins nested deep in the soft creases of the fur-covered surface, then progressively zooms out, distinguishing shapes and objects that form the map. From its rugged edges, we enter the space of its installation and the temporality of its participatory activation.
