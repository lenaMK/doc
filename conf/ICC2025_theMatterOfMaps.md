...
- *PeoPL* by Laura Nsengiyumva

  - challenges the presence Léopold the II’s equestrian statue in Brussels
...
- *On Monumental Silences* by Ibrahim Mahama  
  ...
  - is a work that presents reinterpretations of a monument to the missionary-father De Deken
...
- as reference grid, I set automotive habits aside in favour to [cycling paths](https://www.donneesquebec.ca/recherche/dataset/vmtl-pistes-cyclables). 
...
- even when the “end result” is a physical map[^6]. 
