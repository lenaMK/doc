...
Inscribing the elements of *[…] and counting* into an academic narrative is an opportunity to expose the back-and-forth dynamic between research and creation, where theory serves as inspiration and practice provides fertile ground to further theory. This article will follow a slow backwards movement. It begins nested deep in the soft creases of the fur-covered surface of the map, then progressively zooms out, distinguishing shapes and objects that tell a story of womxn’s public art in Tiohtià:ke · Montréal. From its rugged edges, we enter the space of its installation and the temporality of its participatory activation.
